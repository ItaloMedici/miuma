...
export const editorTheme: EditorThemeClasses = {
  ...
  rtl: "text-right",
  heading: {
    h1: "text-base md:text-lg font-bold mb-3 mt-0 leading-tight text-accent-foreground",
    h2: "text-base md:text-lg font-semibold mb-3 leading-[1.375] text-accent-foreground",
    h3: "text-base md:text-lg font-medium mb-2 leading-[1.5] text-accent-foreground",
    h4: "text-base font-normal mb-2 text-accent-foreground",
    h5: "scroll-m-20 text-lg font-semibold tracking-tight",
    h6: "scroll-m-20 text-base font-semibold tracking-tight",
  },
  paragraph:
    "text-sm md:text-base mb-3 text-justify font-light text-muted-foreground",
  quote:
    "border-l-4 border-primary pl-4 pt-1 pb-1 my-6 italic text-muted-foreground",
  ...
  text: {
    bold: "font-semibold",
    code: "bg-muted text-foreground px-1 py-0.5 rounded text-sm",
    italic: "italic",
